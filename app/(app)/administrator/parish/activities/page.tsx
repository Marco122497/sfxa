...
export default async function AdminParishActivitiesPage() {
  await requireAdmin();
  ...
  return (
    <div className="space-y-6">
      <PageHeading
        ...
        description="Create, edit, publish, or remove parish activities. Members and treasurers see published items only."
        icon={CalendarDaysIcon}
      />
      <AnnouncementManager announcements={announcements} kind="activity" />
    </div>
  );
}
